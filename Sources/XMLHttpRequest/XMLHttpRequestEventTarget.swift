...
extension XMLHttpRequestEventTarget {
    ...
    public func onAbort(_ closure: @escaping (JSValue) -> Void) -> Self {
		...
		(s?._isForUploading == true ? s?.jsValue.upload : s?.jsValue)?.addEventListener.function?.callAsFunction(optionalThis: jsValue.object, "abort", jsClosure)
        return self
    }
    ...
    public func onError(_ closure: @escaping (JSValue) -> Void) -> Self {
		...
		(s?._isForUploading == true ? s?.jsValue.upload : s?.jsValue)?.addEventListener.function?.callAsFunction(optionalThis: jsValue.object, "error", jsClosure)
        return self
    }
    ...
    public func onLoad(_ closure: @escaping (ProgressEvent) -> Void) -> Self {
		...
		(s?._isForUploading == true ? s?.jsValue.upload : s?.jsValue)?.addEventListener.function?.callAsFunction(optionalThis: jsValue.object, "load", jsClosure)
        return self
    }
    ...
    public func onLoadStart(_ closure: @escaping (ProgressEvent) -> Void) -> Self {
		...
		(s?._isForUploading == true ? s?.jsValue.upload : s?.jsValue)?.addEventListener.function?.callAsFunction(optionalThis: jsValue.object, "loadstart", jsClosure)
        return self
    }
    ...
    public func onProgress(_ closure: @escaping (ProgressEvent) -> Void) -> Self {
		...
		(s?._isForUploading == true ? s?.jsValue.upload : s?.jsValue)?.addEventListener.function?.callAsFunction(optionalThis: jsValue.object, "progress", jsClosure)
        return self
    }
    ...
    public func onTimeout(_ closure: @escaping (JSValue) -> Void) -> Self {
		...
		(s?._isForUploading == true ? s?.jsValue.upload : s?.jsValue)?.addEventListener.function?.callAsFunction(optionalThis: jsValue.object, "timeout", jsClosure)
        return self
    }
    ...
    public func onLoadEnd(_ closure: @escaping (JSValue) -> Void) -> Self {
		...
		(s?._isForUploading == true ? s?.jsValue.upload : s?.jsValue)?.addEventListener.function?.callAsFunction(optionalThis: jsValue.object, "loadend", jsClosure)
        return self
    }
}
