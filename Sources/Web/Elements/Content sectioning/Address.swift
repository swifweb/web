...
open class H3: BaseActiveElement, _ScrollHandleable, _StringInitializable {
    var scrollClosure: ScrollClosure?
    var scrollHandler: (UIEvent) -> Void = { _ in }
...
open class H4: BaseActiveElement, _ScrollHandleable, _StringInitializable {
    var scrollClosure: ScrollClosure?
    var scrollHandler: (UIEvent) -> Void = { _ in }
...
open class H5: BaseActiveElement, _ScrollHandleable, _StringInitializable {
    var scrollClosure: ScrollClosure?
    var scrollHandler: (UIEvent) -> Void = { _ in }
...
///
/// [Learn more ->](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input)
open class InputText: BaseActiveElement, _StringInitializable, _ChangeHandleable, _InvalidHandleable, _InputHandleable, _SelectHandleable, _SearchHandleable {
    public override class var name: String { "input" }
...
extension InputText: _Selectable {}
extension InputText: _RangeTextable {}
extension InputText: _SelectionRangeable {}
...
extension InputURL: _Selectable {}
...
extension InputWeek: _Selectable {}
...
/// it is recommended to reference that text with an aria-labelledby attribute rather than using the <title> element.
///
...
/// he <feMorphology> SVG filter primitive is used to erode or dilate the input image.
...
/// The SVG <tspan> element defines a subtext within a <text> element
